...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function AppComponent(covidDataService) {
        ...
        this.width = 550;
        this.height = 400; // public getHistory(country){
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 4,
      consts: [["role", "banner", "routerLink", "home", 1, "toolbar", "cursor-pointer"], ["src", "assets/corona.png", 2, "height", "50px", "text-align", "left"], [1, "spacer"], [1, "mb-2", "pr-1"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    __webpack_require__.n(fusioncharts_themes_fusioncharts_theme_fusion__WEBPACK_IMPORTED_MODULE_19__);
    /* harmony import */


    var _quarantine_counter_quarantine_counter_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./quarantine-counter/quarantine-counter.component */
    "./src/app/quarantine-counter/quarantine-counter.component.ts"); // Import FusionCharts library and chart modules
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _help_center_help_center_component__WEBPACK_IMPORTED_MODULE_12__["HelpCenterComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_13__["HomeComponent"], _quarantine_counter_quarantine_counter_component__WEBPACK_IMPORTED_MODULE_20__["QuarantineCounterComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_7__["MatSelectModule"], angular_google_charts__WEBPACK_IMPORTED_MODULE_8__["GoogleChartsModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_9__["MatIconModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_10__["MatMenuModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_11__["MatButtonModule"], angular_fusioncharts__WEBPACK_IMPORTED_MODULE_14__["FusionChartsModule"]]
      });
    })();
    /*@__PURE__*/
      ...
      _createClass(CovidDataService, [{
        ...
        value: function getHistory(country) {
          ...
          return this.http.get(url, {
            ...
            var newArray = []; // Declare an empty object

            var uniqueObject = {}; // Loop for the array elements

            for (var _i in responseData['stat_by_country']) {
              // Extract the title
              var objTitle = responseData['stat_by_country'][_i]['record_date']; // Use the title as the index

              uniqueObject[objTitle] = responseData['stat_by_country'][_i];
            } // Loop to push unique object into array


            for (i in uniqueObject) {
              var totalCases = parseInt(uniqueObject[i]['total_cases'].replace(',', ''));
              var totaldeaths = parseInt(uniqueObject[i]['total_deaths'].replace(',', ''));
    ...
    function () {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getCovidUpdate(country) {
          ...
          this.covidDataService.getData(country).subscribe(function (data) {
            _this2.covidData = data, _this2.stats = data['latest_stat_by_country'][0];
          }, function (er) {
            return console.log(er);
          });
          this.getHistory(this.country);
        ...
        value: function getStatesSegrigatedData() {
          ...
          this.covidDataService.getStatesData().subscribe(function (data) {
            _this4.statesChart['states'] = data['statesArrayData'], _this4.indiaMapChartData['data'] = data['mapdata'];
          }, function (err) {
  ...
  /***/
  function srcAppQuarantineCounterQuarantineCounterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuarantineCounterComponent", function () {
      return QuarantineCounterComponent;
    });
    /* harmony import */
    ...
    var QuarantineCounterComponent =
    /*#__PURE__*/
    function () {
      function QuarantineCounterComponent() {
        _classCallCheck(this, QuarantineCounterComponent);
      }

      _createClass(QuarantineCounterComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    QuarantineCounterComponent.ɵfac = function QuarantineCounterComponent_Factory(t) {
      return new (t || QuarantineCounterComponent)();
    };

    QuarantineCounterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: QuarantineCounterComponent,
      selectors: [["app-quarantine-counter"]],
      decls: 4,
      vars: 0,
      consts: [[1, "row"], [1, "col-md-12", "bg-primary"]],
      template: function QuarantineCounterComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](QuarantineCounterComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
